...
% using the popup menu or clicking the up arrow button to move up the tree,
% typing a path in the box to move to any directory or right-clicking
% (control-click on Mac) on the path box to revisit a previously-listed
% directory.  (Windows only: To go to a UNC-named resource you will have to
% type the UNC name in the path box, but all such visited resources will be
% remembered and listed along with the mapped drives.)
%
