function [fresult,gof,output,yy,resid,fresult3,gof3,output3,weightvector]=powerfit(xvalues,yvaluesarray,sdb)
...
set(opts,'normalize','off','MaxIter',1*10^8,'MaxFunevals',100000,'Startpoint',[min(yvaluesarray) 1 1 .845  ],'Lower',[-10 -10 -10 -10 ],'Weights',weightvector);
...
set(opts3,'normalize','off','MaxIter',1*10^8,'MaxFunevals',100000,'Startpoint',[min(yvaluesarray) 1 1 ],'Lower',[0 0 0 ],'Weights',weightvector);
