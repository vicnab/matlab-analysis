...
set(opts,'normalize','off','MaxIter',1*10^8,'MaxFunevals',100000,'Startpoint',[min(yvaluesarray) 1 1 .845  255],'Lower',[0 0 0 -10 -100],'Weights',weightvector);
...
set(opts3,'normalize','off','MaxIter',1*10^8,'MaxFunevals',100000,'Startpoint',[min(yvaluesarray) 1 1 255],'Lower',[0 0 0 0],'Weights',weightvector);
