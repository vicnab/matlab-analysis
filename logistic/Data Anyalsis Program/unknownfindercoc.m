...
kk=semilogx(xxx,fit(xxx),xxx,fit2(xxx),xxx(a),yy(a),'bx',xarray1,yarray1,'ks',median(xxx(a)),median(yy(a)),'ro',[MDC, MDC],[0,300 ],'b--',[MaxDC, MaxDC],[0,300],'b--',[median(xxx(a)), median(xxx(a))],[0, median(yy(a))],'r--',[.8, median(xxx(a))],[median(yy(a)), median(yy(a))],'r--');
set(kk,'LineWidth',2);
...
xlabel('Concentration of Ag (a.u.)','FontSize',18)
