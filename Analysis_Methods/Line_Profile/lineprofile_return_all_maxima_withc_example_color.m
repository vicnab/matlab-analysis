...
tic
if(ismac)
    imgdir = '/Users/Ben/matlab-analysis/Analysis_Methods/Line_Profile/fake beads for gradient test.tif'; %i made this in gimp to have "beads" showing different gradients
elseif(ispc)
