...
ncols = 5;%rows and columns of chip, can make an option in function call later
 ...
 R1y = magR1/4 * [0 1 2 3 4] * sind(angR1) + B1(2);
 ...
 beadsx = repmat(R1x, 4, 1);
 beadsy = repmat(R1y, 4, 1);
 xadd = [0 1 2 3]' * cosd(angC1) *magC1/3;
 yadd = [0 1 2 3]' * sind(angC1) *magC1/3; 
 xadd = repmat(xadd, 1, 5);
 yadd = repmat(yadd, 1, 5);
